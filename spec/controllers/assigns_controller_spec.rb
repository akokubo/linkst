...
RSpec.describe AssignsController, :type => :controller do
  ...
  # Assign. As you add validations to Assign, be sure to
  ...
  describe "GET new" do
    it "assigns a new assign as @assign" do
  ...
  describe "GET edit" do
    it "assigns the requested assign as @assign" do
      assign = Assign.create! valid_attributes
      get :edit, {:id => assign.to_param}, valid_session
      expect(assigns(:assign)).to eq(assign)
    end
  end
  ...
  describe "POST create" do
    describe "with valid params" do
      it "creates a new Assign" do
        expect {
          post :create, {:assign => valid_attributes}, valid_session
      ...
      it "redirects to the created assign" do
        post :create, {:assign => valid_attributes}, valid_session
        expect(response).to redirect_to(Assign.last)
      end
    end

    describe "with invalid params" do
      it "assigns a newly created but unsaved assign as @assign" do
        post :create, {:assign => invalid_attributes}, valid_session
        expect(assigns(:assign)).to be_a_new(Assign)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      ...
      it "updates the requested assign" do
        assign = Assign.create! valid_attributes
        put :update, {:id => assign.to_param, :assign => new_attributes}, valid_session
        assign.reload
      ...
      it "assigns the requested assign as @assign" do
        assign = Assign.create! valid_attributes
        put :update, {:id => assign.to_param, :assign => valid_attributes}, valid_session
        expect(assigns(:assign)).to eq(assign)
      end

      it "redirects to the assign" do
        assign = Assign.create! valid_attributes
        put :update, {:id => assign.to_param, :assign => valid_attributes}, valid_session
        expect(response).to redirect_to(assign)
      end
    end

    describe "with invalid params" do
      it "assigns the assign as @assign" do
        assign = Assign.create! valid_attributes
        put :update, {:id => assign.to_param, :assign => invalid_attributes}, valid_session
        expect(assigns(:assign)).to eq(assign)
      end
  ...
  describe "DELETE destroy" do
    ...
    it "redirects to the assigns list" do
      assign = Assign.create! valid_attributes
      delete :destroy, {:id => assign.to_param}, valid_session
      expect(response).to redirect_to(assigns_url)
    end
  end
